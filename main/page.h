...
<html>
  <head>
    ...
    <script>
     ...
     set qos(a){this._setQos(a)},get retained(){return this._getRetained()},set retained(a){this._setRetained(a)},get duplicate(){return this._getDuplicate()},set duplicate(a){this._setDuplicate(a)}};return{Client:I,Message:x}}(window);</script>
  ...
  <body style="display: flex; flex-direction: column; align-items: center;">
    <span style="font-size: 30px;" id="status">Not connceted with server</span>
    <button class="momentary-button", id="23", onmousedown="buttoned(this, 23, 1)", onmouseup="buttoned(this, 23, 0)">Starter</button>
    <button class="momentary-button", id="27", onmousedown="buttoned(this, 27, 1)", onmouseup="buttoned(this, 27, 0)">Air Horn</button>
    <button class="momentary-button", id="28", onmousedown="buttoned(this, 28, 1)", onmouseup="buttoned(this, 28, 0)">Electric Horn</button>
    <button class="momentary-button", id="33", onmousedown="buttoned(this, 33, 1)", onmouseup="buttoned(this, 33, 0)">RPM Up</button>
    <button class="momentary-button", id="34", onmousedown="buttoned(this, 34, 1)", onmouseup="buttoned(this, 34, 0)">RPM Down</button>
    
    <div class="toggle-container">
      <span class="toggle-label">Ignition</span>
      <label class="switch">
        <input type="checkbox", id="22", onchange="toggled(this, 22)">
        <span class="slider round"></span>
      </label>
    </div>
    
    <div class="toggle-container">
      <span class="toggle-label">PTO </span>
      <label class="switch">
        <input type="checkbox", id="24", onchange="toggled(this, 24)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">Crane Power </span>
      <label class="switch">
        <input type="checkbox", id="25", onchange="toggled(this, 25)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">Drop Axle </span>
      <label class="switch">
        <input type="checkbox", id="26", onchange="toggled(this, 26)">
        <span class="slider round"></span>
      </label>
    </div>
    ...
    <div class="toggle-container">
      <span class="toggle-label">Running Lights</span>
      <label class="switch">
        <input type="checkbox", id="29", onchange="toggled(this, 29)">
        <span class="slider round"></span>
      </label>
    </div>
    ...
    <div class="toggle-container">
      ...
      <label class="switch">
        <input type="checkbox", id="30", onchange="toggled(this, 30)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">Hazard Lights</span>
      <label class="switch">
        <input type="checkbox", id="31", onchange="toggled(this, 31)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">Cruise Control</span>
      <label class="switch">
        <input type="checkbox", id="32", onchange="toggled(this, 32)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">T1</span>
      <label class="switch">
        <input type="checkbox", id="35", onchange="toggled(this, 35)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">T2</span>
      <label class="switch">
        <input type="checkbox", id="36", onchange="toggled(this, 36)">
        <span class="slider round"></span>
      </label>
    </div>

    <div class="toggle-container">
      <span class="toggle-label">T3</span>
      <label class="switch">
        <input type="checkbox", id="37", onchange="toggled(this, 37)">
        <span class="slider round"></span>
      </label>
    </div>
...
<script>
  ...
  function toggled(element, x) {
    ...
    let payload = new Paho.MQTT.Message(msg);
    payload.destinationName = "/Arduino/data";
    client.send(payload);
  }

  function buttoned(element, pin, state) {
    let msg = '';
    if(state == 1) {
      msg = `${pin}:1`;
      console.log(pin, "on");
  ...
  function onConnect() {
    ...
    statusMsg.innerHTML = "Connected to server";
    mqttConnceted = true;
  }

  function onFailure(message) {
    mqttConnceted = false;
    statusMsg.innerHTML = "Not connected with server";
  } 
  ...
  function onMessageArrived(message) {
    ...
    if(obj["m"] == "a") {
      for(let i=0; i<16; i++) {
        element = document.getElementById((22+i).toString())
        state = obj["v"][i];
        if(element.tagName === "INPUT") {
          state == 1 ? element.checked = true : element.checked = false;
        }
      }
    }
  }
